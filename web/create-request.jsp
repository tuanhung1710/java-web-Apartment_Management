        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white p-3 d-flex align-items-center">
                    ...
                    <h4 class="mb-0">Tạo Yêu Cầu Hỗ Trợ Mới</h4>
                </div>
                <div class="card-body p-4">
                    
                    <%-- Thông báo lỗi hệ thống/DB (nếu có) --%>
                    ...
                    <form action="${pageContext.request.contextPath}/resident/request/create" method="POST">
                        ...
                        <!-- Thời gian dự kiến (Chỉ hiện khi chọn Chuyển đồ) -->
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <!-- Link Hủy mặc định chuyển về danh sách -->
                            <a href="${pageContext.request.contextPath}/resident/request/list" class="btn btn-outline-secondary px-4 me-md-2">Hủy bỏ</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Chạy lần đầu khi load trang (quan trọng khi bị redirect lỗi về trang này)
        toggleScheduledTime();
